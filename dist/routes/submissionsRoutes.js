...
submissionsRoutes.post("/:submissionId/purchase", authMiddleware_1.isAuthenticated, (0, authMiddleware_1.checkPermission)(client_1.Role.FOOD_BUNDLE, client_1.Role.ADMIN), ProductVerifyController_1.default.purchaseProduct);
// Clear submission
submissionsRoutes.put("/:submissionId/clear", authMiddleware_1.isAuthenticated, (0, authMiddleware_1.checkPermission)(client_1.Role.FOOD_BUNDLE, client_1.Role.ADMIN), ProductVerifyController_1.default.clearSubmission);
