...
userRoutes.patch("/farmers/:id", UserController.updateFarmer);
...
userRoutes.patch("/restaurants/:id", UserController.updateRestaurant);
...
userRoutes.patch("/admins/:id", UserController.updateAdmin);
